var TimeKeepingReportFactory = function ($rootScope, $localstorage, $timeout, CommonFactory) {
    var service = {};
...
TimeKeepingReportFactory.$inject = ["$rootScope", "$localstorage", "$timeout", "CommonFactory"];
